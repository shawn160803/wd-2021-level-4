...
describe("To do list test suits", () => {
  beforeAll(() => {
    ...
    add({ title: "mobile service", dueDate: today, completed: false });
    add({ title: "allotment", dueDate: tomorrow, completed: false });
    add({ title: "jogging", dueDate: tomorrow, completed: false });
  });
